...
def migrate_forms_ficha_medica():
    ...
    try:
        ...
        print(f"[Migration] Error en migrate_forms_ficha_medica: {e}")


def migrate_forms_pasaporte_fecha_nacimiento():
    ...
    try:
        ...
        print(f"[Migration] Error en migrate_forms_pasaporte_fecha_nacimiento: {e}")
